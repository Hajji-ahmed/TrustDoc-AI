...
% Le document tient sur deux pages : l'interligne et les espaces entre sections
% sont desserrés en conséquence, plutôt que de laisser une page dense et une
% page vide.
...
%% ------------------------------------------------------ 4
% Coupure au changement de sujet : clients, valeur et modèle d'un côté, marché
% et exécution de l'autre. Les deux pages restent ainsi cohérentes seules.
\newpage
